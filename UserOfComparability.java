...
public class UserOfComparability {
    ...
    public static void main(String[] commandLine) {
        ...
        System.out.println( System.lineSeparator()
                          + "Date comparisons");
        Date d0 = new Date(2019, 4, 4); // yesterday
        reportRelationship( "Date vs. itself", d0, d0, "0");
        reportRelationship( "Date vs. next date"
                          , d0, new Date(2019, 4, 5), "negative int");
        reportRelationship( "Date vs. past date"
                          , d0, new Date(2002, 6, 25), "positive int");
/*
        System.out.println( System.lineSeparator()
                          + "Nonsensical dog comparison");
        reportRelationship( "dog vs. dog", new IncomparableDog()
                            , new IncomparableDog(), "error");
//error: incompatible types: IncomparableDog cannot be converted to Comparable

        System.out.println( System.lineSeparator()
                          + "Nonsensical point-date comparison");
        reportRelationship( "point vs. date", p0, d0, "error");
//error: Exception in thread "main" java.lang.ClassCastException: Date cannot be cast to Point
*/
    }
